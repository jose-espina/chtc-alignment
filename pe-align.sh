...
cp -r /staging/groups/roopra_group/jespina/index/mm10.tar.gz index
...
# run bowtie2
bowtie2 --end-to-end --very-sensitive --no-mixed --no-discordant --phred33 -I 10 -X 700 -p 8 -x index/mm10 \
-1 input/$fastq1 -2 input/$fastq2 -S ouput/${samplename}_bowtie2.sam 
